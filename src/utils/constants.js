export const CONTRACT_ADDRESSES = {
  ...
  base: "0x8ea3818294887376673e4e64fBd518598e3a2306" // NOWY KONTRAKT HUBChatRewards
};
...
export const NETWORK_CONFIG = {
  celo: {
    ...
    supportsSubscriptions: false, // Celo nie ma subskrypcji
  ...
  base: {
    ...
    supportsSubscriptions: true, // Base MA subskrypcje
    supportsDailyRewards: false,
    supportsSeasonSystem: false
  }
};

// NOWY: ABI dla kontraktu HUBChatRewards na Base
export const HUB_CHAT_REWARDS_ABI = [
  ...
  },
  {
    ...
    "name": "SubscriptionDurationUpdated",
    "type": "event"
  },
  {
    "anonymous": false,
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum HUBChatRewards.Tier",
        "name": "tier",
        "type": "uint8"
      },
      {
  ...
  },
  {
    ...
    "name": "getRemainingDailyMessages",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
...
// ABI dla starych kontraktów (kompatybilność wsteczna)
export const CONTRACT_ABIS = {
  ...
  base: HUB_CHAT_REWARDS_ABI // Nowy kontrakt używa tego samego ABI
};
